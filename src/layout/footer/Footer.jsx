      ...
      <div className="w-[95%] md:w-[85%] mx-auto border border-primary bg-gradient-to-t from-[#00002f] to-transparent text-white">
        <section>
          <div className="px-12 py-6">
            ...
            <div className="pt-6 flex items-start gap-14">
                <div className="w-[35%]">
                ...
                <div className="w-[65%] grid grid-cols-4 justify-items-center gap-4">
                    <div>
                        <h4 className="text-subheading text-base mb-4 uppercase">MoonVault</h4>
